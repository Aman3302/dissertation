% Appendix section explaining the specifics of our radiative transfer model
\section{The \code{McFACTS} Code} \label{sec:apdx-mcfacts}

\counterwithin{figure}{section}
\counterwithin{table}{section}

The bulk of this appendix was published in \citet{McKernan+25-mcafactsI}. Please use that reference when citing this section.
...
We retrieve the timescales and changes in parameters for each phase of this evolution from Figure 12 (specifically, stage 1 is $\sim1.5\times10^5$~yr, when $e=0.7\rightarrow 0.9999$, $a=100\rightarrow60~r_g$, $i=175\rightarrow165^{o}$; stage 2 is $\sim10^4$~yr, when $i=165\rightarrow12^{o}$, $e=0.9999\rightarrow0.9$, $a=60~r_g$; and stage 3 is $\sim10^4$~yr, when $i=12\rightarrow0.0^{o}$, $e=0.9\rightarrow0.5$, $a=60\rightarrow20~r_g$).
...
We scale the behavior for an orbiter identical to the first example, except for $\omega$, using scaling for timescales derived from \cite{WangZhuLin24} Figure 8 (specifically, in $\sim1.5 \times10^7~$yr $a=100\rightarrow60\,r_g$, $e=0.7\rightarrow0.5$, $i=175\rightarrow170^{o}$).
...
We intend to incorporate a wider range of binary formation conditions \citep{Stan+23,Rowan+23,Qian+24,Whitehead+24} in future versions of the code.
