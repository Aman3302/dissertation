...
Thus, thicker disks are more likely to obscure embedded SNe than thin disks.
...
Even fields that produce a plasma $\beta \equiv P_{\rm gas} / P_{\rm mag} = 10^{2.5}$ in the midlpane can become magnetically dominated away from the midplane and effectively increase the scale height relative to disks with much weaker fields at $\beta=10^4$ \citep{Gerling-Dunsmore+25}.
