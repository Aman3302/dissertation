...
\subsection{The Sirens - Multimessenger Probes of AGN Disks}
% EM
%  - Disk
%  - NSC Transients
% GW
...
% Hydrodynamics
% Post-Processing Radiative Transfer


Binary black hole (BBH) mergers are observed in gravitational waves (GW) at an increasing rate as LIGO-Virgo-KAGRA (LVK) improve detector sensitivities \citep[e.g.][ see also \footnote{https://gracedb.ligo.org/superevents/public/O4/}]{Abbott+20-GW190521astro}.
