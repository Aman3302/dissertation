...
When gas accretes onto the SMBH from a torroidal reservoir, it forms an accretion disk that can reach and becomes an active galactic nucleus (AGN) spanning a range of luminosities \citep{Hubeny+01} that emit across the electromagnetic spectrum with characteristic spectral features that are likely imparted by combinations of viewing angle effects and accretion rate \citep{Antonucci93,Netzer15}.
Highly spinning SMBH with strong magnetic fields can produce jets that eject material with enough kinetic energy to leave the galaxy or galaxy cluster entirely \citep{Need citation for Jets}.
The cartoon in \Fig{fig:agn-components} \citep{Thorne22} presents a schematic view of the environment.

\begin{figure}
\centering
\includegraphics[width=1\textwidth]{intro_figs/AGNUnificationSteps_AGNComponents.png}
...
Prior to 2015 the field of multi-messenger astronomy was restricted to three sources: electromagnetic radiation, cosmic rays, and neutrinos.
...
Then, an electromagnetic counterpart, named kilonova AT2017gfo, was observed in the galaxy NGC 4993 \citep{emGW170817} sparking a new age of multi-messenger astronomy.
...
In the future, the Laser Interferometer Space Antenna \citep[LISA][]{LISA17,LISA23} will enable observations of extreme- and intermediate-mass ratio inspirals \citep[EMRI and IMR, respectively][]{Speri+26} which are comprised of single stellar mass BHs that emit long-lived GWs as they approach the event horizon of a SMBH, which emit at the $\sim10^{-4}-10^{-1}$~Hz range.
...
BHs embedded in AGN disks experience gas torques and can migrate \citep[e.g.][]{Syer91,Levin07,McKernan+12}.
Differential migration leads to encounters with other BH (as well as neutron stars and stars) and binary formation.
Binaries in AGN can be hardened or softened via dynamical encounters \citep[e.g.][]{Leigh+18,Samsing20,Wang21} or gas torques  \citep[e.g.][]{Tiede20,Derdzinski21,YapingLi21}.
...
Such mergers can occur at migration traps \citep[e.g.][]{Lyra+10,Sandor+11,Horn+12,Bellovary2016,Yang+19,Secunda+20}, in the bulk disk \citep[e.g.][]{Tagawa20a,McK20a} and kicked outside the disk itself \citep{Tagawa20b}.
...
These mergers in AGN disks will be detectable with gravitational waves \citep{McKernan+14,Bartos+17,Stone+17,Secunda+19} and could produce measurable electromagnetic counterparts from interactions with the AGN gas which would be otherwise absent for two black holes merging in the field \citep{McKernan+19,Perna21}.
...
As our detectors become more sensitive and the detection algorithms become more accurate, electromagnetic follow-up campaigns will become easier and more targeted.
...
These potential sources of noise must be studied to enable the search for potential electromagnetic counterparts to BBH mergers.

The first candidate electromagnetic counterpart to a gravitational wave detected binary black hole (BBH) merger was reportedly observed as a flare in AGN J124942.3+344929 that by the Zwicky Transient Facility (ZTF)  designated ZTF19abanrhr \citep{Graham+20}.
...
They dismissed a SN as the source of the flare because it did not show any color evolution as is typical of SNe light curves \citep{Foley+11}.
...
The work presented details the effort to expand on it with a new code that is more robust, flexible, and user-friendly.
...
We verify these predictions with three-dimensional hydrodynamic simulations of a SN embedded in a vertically stratified shearing disk by exploring multiple radial and vertical locations in the disk.
...
\begin{itemize}
\item What do the properties of binary black hole mergers in active galactic nucleus accretion disks reveal about the nuclear star cluster and disk properties?

\item What are the distinguishing characteristics of core-collapse supernovae that occur in accretion disks, and are they observable?
\end{itemize}
